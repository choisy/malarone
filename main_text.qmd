...
number due to the indirect effects $\alpha$, $\beta$ and $\gamma$ of malarone in the
case where malarone is given to a proportion $\tau$ of the newly infected. Note here
that treatment is given to infected only once and $D$ here is just an integration
