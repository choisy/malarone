...
plot_treatment <- function(x, f = plot_pi_D, ylim = 0:1, axis1fct = axis1,
                           ...
                           plt_grd = make_grid1(ats, prev), ylab = ylab_pi) {
  f0 <- function(...) f(..., ylim = ylim, plot_grid = plt_grd)
...
#plot_mass_treatment(pi_vals)
plot_treatment(pi_vals)
```

```{r}
plot_treatment(rho_vals, f = plot_tau_rho, axis1fct = function() axis(1),
               add_lgd = make_legend(title = "prevalence", text.width = 0),
               plt_grd = function() {
...
pi_vals |>
  R0_effect() |> 
  plot_mass_treatment(ylim = c(0, 10), hlines = 1:9)
```
...
pi_vals2 <- mutate(pi_vals, R0 = exp(-g * n))
