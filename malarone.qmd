...
@aleshnick_experimental_2020 and 1 of @miura_strong_2019. Let's first look at the
distribution of the oocyst loads from the control data:
...
The cumulative distribution together with a fitted geometric distribion:
...
Let's now look at the data from @aleshnick_experimental_2020 converted to oocyst load
using the 1,000 factor of @miura_strong_2019:
