...
pi <- function(lambda, prop) {
  lambda |> 
    ...
    mutate(pi = 1 - (1 - min_of_following(lambda)) * prop, .by = c(n, g))  
}
```
...
plot_pi_D <- function(x, xlab = "intake frequency (/day)", ylab = ylab_pi) {
  ...
  x |> 
    group_split(prop) |> 
    walk2(YlOrRd11, ~ with(.x, lines(D, pi, col = .y, lwd = lwd_val)))
}
...
plot_pi_D2(filter(pi_vals, n ==  6, g <  .1))
mtext2(6); axis(2)
plot_pi_D4(filter(pi_vals, n ==  6, g == .1))
mtext2(10)
legend5("bottomleft", title = "proportion treated", text.width = .5,
        legend = paste(seq(0, 100, 10), "%"))
plot_pi_D4(filter(pi_vals, n ==  6, g >  .1))
mtext2(14); mtext3(14)
plot_pi_D2(filter(pi_vals, n == 10, g <  .1))
axis(2)
plot_pi_D4(filter(pi_vals, n == 10, g == .1))
plot_pi_D4(filter(pi_vals, n == 10, g >  .1))
mtext3(10)
plot_pi_D(filter(pi_vals, n == 14, g <  .1))
axis1(); axis(2)
plot_pi_D3(filter(pi_vals, n == 14, g == .1))
axis1()
plot_pi_D3(filter(pi_vals, n == 14, g >  .1))
axis1(); mtext3(7)
par(opar)
