...
Figure 2B from @aleshnick_experimental_2020 suggests a non-linear relationship between
the sporozoite load $L$ and the transmission efficiency $b$ from mosquito to human. The
