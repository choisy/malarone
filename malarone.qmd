...
Let's call $\rho$ the reduction of $R_0$. From we can see that this
...
make_rho <- function(D, L, g, n, tau) {
  X <- seq2(0, 1)
  tX <- tau * X
#  ef <- 1 - tX * effect_on_treated(D = 14 * 24, L = 6e4, g = 1 / (14 * 24), n = 7 * 24)
  ef <- 1 - tX * lambda(D = 14 * 24, L = 6e4, g = 1 / (14 * 24), n = 7 * 24)
